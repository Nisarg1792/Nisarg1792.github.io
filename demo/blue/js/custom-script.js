$(window).load(function() {
    $(".site-loder").delay(2000).fadeOut('slow', function() {
        ...
        /*==================== typed ====================*/
        $(".element").typed({
            strings: ["Web UX <i>designer</i>", "And <i>Developer.</i>"],
            stringsElement: null,
            typeSpeed: 100,
            startDelay: 1000,
            backSpeed: 10,
...
$(function() {
    ...
    $('#technical-skill').each(function () {
        ...
        $this.appear(function() {
            ...
            $('#technical-skill #wordpress').animateNumber({ number: 95 }, 2000);
            $('#technical-skill #html').animateNumber({ number: 85 }, 2000);
            $('#technical-skill #css').animateNumber({ number: 65 }, 2000);
            $('#technical-skill #mobile-apps').animateNumber({ number: 95 }, 2000);
            $('#technical-skill #ps').animateNumber({ number: 90 }, 2000);
            $('#technical-skill #web-development').animateNumber({ number: 80 }, 2000);
            $('#technical-skill #branding-design').animateNumber({ number: 70 }, 2000);
            $('#technical-skill #ai').animateNumber({ number: 50 }, 2000);
        });
    });
